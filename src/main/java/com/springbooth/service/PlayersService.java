...
public class PlayersService {
	...
	public Players copyDtoToEntity(PlayersDTO playersDTO) {
		...
		if (playersDTO.getPlayerId() != null) {
			Players county = playersRepo.findByPlayerId(playersDTO.getPlayerId());
			players.setCountry(county.getCountry());
		} else {
			Country country = new Country();
			country.setCountryId(playersDTO.getCountryDTO().getCountryId());
